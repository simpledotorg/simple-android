...
class Migration57AndroidTest : BaseDatabaseMigrationTest(56, 57) {
  ...
  private fun PatientProfile.withSyncStatus(syncStatus: SyncStatus): PatientProfile {
    return copy(patient = this.patient.copy(syncStatus = syncStatus))
  }

  private fun SupportSQLiteDatabase.savePatientProfile(patientProfile: PatientProfile) {
  ...
  private fun SupportSQLiteDatabase.assertPatient(patient: Patient) {
    with(patient) {
