...
@Suppress("ClassName")
class Migration_93 @Inject constructor() : Migration(92, 93) {
  ...
  override fun migrate(database: SupportSQLiteDatabase) {
    database.inTransaction {
      ...
      execSQL("""
      CREATE VIEW `OverdueAppointment` AS SELECT P.fullName, P.gender, P.dateOfBirth, P.age_value, P.age_updatedAt, P.assignedFacilityId patientAssignedFacilityUuid, P.registeredFacilityId patientRegisteredFacilityID,
