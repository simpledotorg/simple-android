...
class UserSession @Inject constructor(
    ...
    @Named("last_patient_pull_token") internal val patientSyncPullToken: Preference<Optional<String>>,
    @Named("last_bp_pull_token") internal val bpSyncPullToken: Preference<Optional<String>>,
    @Named("last_prescription_pull_token") internal val prescriptionSyncPullToken: Preference<Optional<String>>,
    @Named("last_appointment_pull_token") internal val appointmentSyncPullToken: Preference<Optional<String>>,
    @Named("last_communication_pull_token") internal val communicationSyncPullToken: Preference<Optional<String>>,
    @Named("last_medicalhistory_pull_token") internal val medicalHistorySyncPullToken: Preference<Optional<String>>
) {
