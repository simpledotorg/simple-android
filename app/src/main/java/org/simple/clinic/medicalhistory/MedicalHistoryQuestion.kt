...
enum class MedicalHistoryQuestion(@StringRes val questionRes: Int) {
  DIAGNOSED_WITH_HYPERTENSION(R.string.medicalhistory_diagnosis_hypertension),
  ...
  DIAGNOSED_WITH_DIABETES(R.string.medicalhistory_diagnosis_diabetes),
  IS_ON_HYPERTENSION_TREATMENT(R.string.medicalhistory_question_is_on_hypertension_treatment),
  IS_ON_DIABETES_TREATMENT(R.string.medicalhistory_question_is_on_diabetes_treatment)
}
