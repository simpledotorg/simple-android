...
class PatientRepository @Inject constructor(
  ...
  fun patientAndAssignedFacility(patientUuid: UUID): Observable<PatientAndAssignedFacility> {
    return database.patientDao().patientAndAssignedFacility(patientUuid)
  }
