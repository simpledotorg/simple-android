...
class ReturnScoreSync @Inject constructor(
    private val syncCoordinator: SyncCoordinator,
    private val api: ReturnScoreSyncApi,
    private val repository: ReturnScoreRepository,
    @TypedPreference(TypedPreference.Type.LastReturnScorePullToken) private val lastPullToken: Preference<Optional<String>>,
    @SyncConfigType(SyncConfigType.Type.Frequent) private val config: SyncConfig
) : ModelSync {

  override val name: String = "ReturnScore"
