...
class Migration115AndroidTest : BaseDatabaseMigrationTest(114, 115) {

  @Test
  fun patient_is_eligible_for_reassignment_should_be_change_to_eligible_for_reassignment() {
    ...
    after.query(""" SELECT * FROM Patient """).use { cursor ->
      ...
      cursor.assertValues(mapOf(
          ...
          "assignedFacilityId" to UUID.fromString("b61a1cbd-e31e-4fdc-860a-dcd08b22693c"),
          "retainUntil" to null,
          "eligibleForReassignment" to "unknown"
      ))
    }
  }
}
