...
class RoomMigrationsModule {
  ...
  fun databaseMigrations(
      ...
      migration96: Migration_96,
      migration97: Migration_97,
      migration98: Migration_98,
      migration99: Migration_99,
      migration100: Migration_100,
      migration101: Migration_101,
      migration102: Migration_102,
      migration103: Migration_103,
      migration104: Migration_104,
      migration105: Migration_105,
      migration106: Migration_106,
      migration107: Migration_107,
      migration108: Migration_108,
      migration109: Migration_109,
      migration110: Migration_110,
      migration111: Migration_111,
      migration112: Migration_112,
      migration113: Migration_113,
      migration114: Migration_114,
      migration115: Migration_115,
      migration116: Migration_116,
      migration117: Migration_117,
      migration118: Migration_118,
      migration119: Migration_119,
      migration120: Migration_120,
      migration121: Migration_121,
      migration122: Migration_122,
      migration123: Migration_123,
  ): List<Migration> {
    return listOf(
        migration_3_4,
        migration_4_5,
