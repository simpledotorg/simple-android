...
class BloodPressureHistoryScreenUpdateTest {
  ...
  fun `when blood pressure history is loaded, then show blood pressures`() {
    val patientUuid = UUID.fromString("6b455aea-1580-4900-9524-c19a4d3db676")
    ...
    val updateSpec = UpdateSpec<BloodPressureHistoryScreenModel, BloodPressureHistoryScreenEvent, BloodPressureHistoryScreenEffect>(BloodPressureHistoryScreenUpdate())
