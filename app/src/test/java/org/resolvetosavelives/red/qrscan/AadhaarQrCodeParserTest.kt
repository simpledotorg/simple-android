...
class AadhaarQrCodeParserTest {
  ...
  fun `when an aadhaar xml is received then it should be correctly parsed`() {
    val parsed1 = aadharParser.parse("<?xml version=\"1.0\" encoding=\"UTF-8\"?><PrintLetterBarcodeData uid=\"236619772007\" " +
    ...
    val parsed2 = aadharParser.parse("<?xml version=\"1.0\" encoding=\"UTF-8\"?> <PrintLetterBarcodeData uid=\"997593729482\" " +
