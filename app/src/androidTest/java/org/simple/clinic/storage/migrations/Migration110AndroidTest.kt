...
class Migration110AndroidTest : BaseDatabaseMigrationTest(109, 110) {

  @Test
  fun migration_to_110_should_add_monthlyScreeningReportsEnabled_fields_and_set_default_values() {
