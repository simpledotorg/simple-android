...
class PrescribedDrugScreenV2(context: Context, attrs: AttributeSet) : LinearLayout(context, attrs) {
  ...
  private val toolbar by bindView<Toolbar>(R.id.prescribeddrugs_toolbarv2)
  private val recyclerView by bindView<RecyclerView>(R.id.prescribeddrugs_recyclerviewv2)
  private val doneButtonFrame by bindView<PrimarySolidButtonWithFrame>(R.id.prescribeddrugs_donev2)
