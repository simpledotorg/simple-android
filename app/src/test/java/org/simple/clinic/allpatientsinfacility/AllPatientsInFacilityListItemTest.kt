...
class AllPatientsInFacilityListItemTest {
  ...
  fun `search results must be mapped to list items correctly`() {
    // given
    val facility = TestData.facility(uuid = UUID.fromString("887c5fd8-e2bf-4ae0-bdc8-8ade18a7898a"), name = "Test Facility")
    val patientSearchResults = listOf(
        TestData.patientSearchResult(uuid = UUID.fromString("a8b66bb7-231f-45af-9216-866e2ef0eae8")),
        TestData.patientSearchResult(uuid = UUID.fromString("d80d26e8-5a16-4397-94b7-acce4a65f63c")),
        TestData.patientSearchResult(uuid = UUID.fromString("ed6ce886-cb27-4574-93c9-a4fc133ff734"))
