...
class UpdatePhoneNumberDialog : AppCompatDialogFragment() {
  ...
  private val phoneEditText by bindView<EditText>(R.id.updatephone_phone)
  ...
  private fun saveClicks() =
      RxView
          .clicks(saveButton)
          .map { UpdatePhoneNumberSaveClicked(phone = phoneEditText.text.toString()) }
  ...
  companion object {
    private const val TAG = "UpdatePhoneNumberDialog"
