...
@Suppress("ClassName")
class Migration_115 @Inject constructor() : Migration(114, 115) {

  override fun migrate(db: SupportSQLiteDatabase) {
    db.inTransaction {
      execSQL("""
        ALTER TABLE "Patient" ADD COLUMN "eligibleForReassignment" TEXT NOT NULL DEFAULT "unknown"
      """)
...
""")
      execSQL("""
        ALTER TABLE "Patient" DROP COLUMN "isEligibleForReassignment"
      """)
    }
  }
}
