...
class CallPatientUiRendererTest {
  ...
  fun `if the secure call feature is enabled and overdue list changes is enabled, show the secure call ui`() {
    ...
    verify(ui).renderPatientDetails(name = patientProfile.patient.fullName,
        ...
        diagnosisWithDiabetes = overdueAppointment.diagnosedWithDiabetes,
        diagnosisWithHypertension = overdueAppointment.diagnosedWithHypertension,
