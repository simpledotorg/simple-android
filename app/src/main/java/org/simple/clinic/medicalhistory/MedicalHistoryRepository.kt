...
class MedicalHistoryRepository @Inject constructor(
  ...
  fun historyForPatientOrDefault(
    ...
    val defaultValue = MedicalHistory(
        ...
        isOnHypertensionTreatment = Unanswered,
  ...
  fun save(
    ...
    val medicalHistory = MedicalHistory(
        ...
        isOnHypertensionTreatment = historyEntry.isOnHypertensionTreatment,
        isOnDiabetesTreatment = historyEntry.isOnDiabetesTreatment,
