...
class PrescribedDrugsScreenControllerV2Test {
  ...
  private val screen = mock<PrescribedDrugScreenV2>()
  ...
  private lateinit var controller: PrescribedDrugsScreenControllerV2

  @Before
  fun setUp() {
    controller = PrescribedDrugsScreenControllerV2(userSession, facilityRepository, protocolRepository, prescriptionRepository)
