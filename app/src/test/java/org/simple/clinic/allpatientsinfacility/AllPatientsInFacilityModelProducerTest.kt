...
class AllPatientsInFacilityModelProducerTest {
  private val uiEventsSubject = PublishSubject.create<AllPatientsInFacilityEvent>()
  ...
  private fun dispatchScreenCreatedEvent() {
    MobiusTestFixture<AllPatientsInFacilityModel, AllPatientsInFacilityEvent, AllPatientsInFacilityEffect>(
        uiEventsSubject,
        defaultModel,
